...
import ani.saikou.sharedui.screens.player.VideoPlayerScreen
import ani.saikou.sharedui.screens.reader.MangaReaderScreen
...
import ani.saikou.sharedui.screens.torrent.TorrentSearchScreen
...
fun SaikouNavHost(
    ...
    NavHost(
        ...
        composable(
            ...
            VideoPlayerScreen(
                ...
                onNextEpisode = { nextEp ->
                    navController.navigate(Screen.VideoPlayer.createRoute(mediaId, nextEp)) {
        ...
        // ── Seasonal Calendar ─────────────────────────────────
        composable(Screen.SeasonalCalendar.route) {
            SeasonalCalendarScreen(
                onNavigateToMedia = { id -> navController.navigate(Screen.MediaDetail.createRoute(id)) },
                onBack = { navController.popBackStack() },
            )
        }
