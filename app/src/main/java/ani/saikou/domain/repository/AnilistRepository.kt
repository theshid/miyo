...
interface AnilistRepository {
    ...
    suspend fun getSeasonalAnime(season: String, year: Int, page: Int = 1): List<Media>
    suspend fun getAiringSchedule(weekStart: Long, weekEnd: Long, page: Int = 1): List<AiringEntry>
